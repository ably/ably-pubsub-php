...
/**
 * RSC19d, HP1 - This class is used as a container for response data from PubSubHttpClient::request
...
class HttpPaginatedResponse extends PaginatedResult {
    ...
    /**
     * Constructor.
     * @param \Ably\PubSub\PubSubHttpClient $ably Ably API instance
     ...
     */
    public function __construct( \Ably\PubSub\PubSubHttpClient $ably, $model, $cipherParams,
